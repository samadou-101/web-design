...
const Hero = () => {
  return (
    <div className="relative h-fit min-h-screen w-full overflow-hidden">
      ...
      {/* Content */}
      <div className="2sm:space-y-4 3sm:space-y-3 relative z-10 flex min-h-full flex-col space-y-2 p-4 pt-14 sm:space-y-6 sm:pt-16 md:space-y-5 md:pt-20 lg:space-y-8">
        <Header />
        <HeroText />
      </div>
    </div>
