...
const Hero = () => {
  ...
  return (
    <div className="relative h-fit min-h-screen w-full overflow-hidden">
      ...
      <div
        className="5xl:bg-[center_60%] absolute top-0 -left-[1.8px] -z-10 h-full w-full bg-cover bg-[center_bottom] bg-no-repeat sm:bg-[center_70%] lg:bg-[center_60%] xl:bg-[center_50%]"
