  ...
  return (
    <div className="relative -mr-40 flex items-end gap-8">
      ...
      <div className="relative m-8 w-fit max-md:min-w-[350px] md:m-2">
        ...
        {/* Blur Overlay */}
        <div className="absolute inset-0 z-3 h-[108%] w-[104%] rounded-lg bg-white/40 backdrop-blur-lg"></div>

        {/* Top Image */}
        <img
          src={table_chairs}
          alt="Overlayed Image"
          className="absolute inset-0 -top-4 z-6 hidden h-auto w-full rounded-lg"
        />
      </div>
    </div>
  );
